...
enum LinuxPanePlacementResolution {
...
extension AppController {
    func resolveControlPanePlacement(_ fallback: OverlayPane?, paneID: String?, in session: Session,
                                     requireVisible: Bool, invalidPaneError: String) -> LinuxPanePlacementResolution {
        var pane = fallback
